...
This document presents the analysis utilizes GSVA,AUC scores, and ORA to interpret the biological significance behind gene expression patterns. Here, we analysis epithelial cells, actually, the process could use for any celltype or the entire data.
...
#### Step 3:  Using clusterProfile to conduct pathway enrichment analysis  
